...
let fruit = 'apple';
let fruit_bad = 'expired';

if (fruit_bad === 'expired'){
  fruit = 'orange';
}

console.log('task 1b:', fruit);
...
function hungryDog(weight1, age1){
  if(age1 >= 1 && weight1 <= 5){
    return weight1 * 0.05;
  }else if (age1 >=1 && weight1 >= 6 && weight1 <= 10){
    return weight1 * 0.04;
  }else if (age1 >=1 && weight1 >= 11 && weight1 <= 15){
    return weight1 * 0.03;
  }else if (age1 >=1 && weight1 >= 15){
    return weight1 * 0.02;
  }else if (age1 < 1 && age1 >= 0.583){
    return weight1 * 0.04;
  }else if (age1 < 0.583 && age1 >= 0.333){
    return weight1 * 0.05;
  }else if (age1 < 0.333 && age1 >= 0.166){
    return weight1 * 0.1;
  }else{
...
//Because Math.random gives us a random number between 0 and 1, we split the choices 'equally' so the computer can play RPS
if(computer <= 0.34){
  computer = 'scissors';
...
console.log('Stretch:', vowelCounter("Pterodactyl"));
